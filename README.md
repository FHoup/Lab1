...
Рассматривать нужно две основные ситуации. Первое число больше второго: далее рассматриваем
случаи когда третье число больше четвертого, и обратный случай. Вторая ситуация: когда второе число
больше первого, а далее повторяем алгоритм из первой ситуации. 
...
2. **Сравнение чисел:**
   ...
   *Число 2 больше числа 1:*
    1. В этом случае рассматриваем вариант, что число 4 больше числа 3, а после число 2
      сравниваем с числом 3. Если число 3 больше числа 2, выводим ответ (Число 2). Если нет,
      то рассматриваем варианты: число 3 больше числа 1(Если да, то ответ - число 3), и если нет, то вариант: число 4 больше числа 1 (Если да, то ответ
      число 1, если нет, то - число 4) 

   *Число 1 больше числа 2:*
    1. В этом случае повторяем алгоритм из пункта 1
